...
import com.example.cypics.adapters.ChatAdapter
import com.example.cypics.databinding.ActivityChatScreenKotlinBinding
...
class chat_screen_kotlin : AppCompatActivity() {
    private var messageList: ArrayList<Message> = ArrayList()
    private lateinit var binding: ActivityChatScreenKotlinBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityChatScreenKotlinBinding.inflate(layoutInflater)
        ...
        binding.btnSend.setOnClickListener {
            ...
            if (message.isNotEmpty()) {
                ...
                Toast.makeText(this@chat_screen_kotlin, "Please enter text!", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun updateUI(response: DetectIntentResponse) {
        ...
        if (botReply.isNotEmpty()) {
            ...
            Toast.makeText(this@chat_screen_kotlin, "something went wrong", Toast.LENGTH_SHORT).show()
        }
    }
}